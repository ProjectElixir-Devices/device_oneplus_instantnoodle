...
git clone --depth=1 https://github.com/ProjectElixir-Devices/vendor_oneplus_instantnoodle.git vendor/oneplus/instantnoodle
...
git clone --depth=1 https://github.com/ProjectElixir-Devices/android_kernel_oneplus_sm8250.git kernel/oneplus/sm8250
